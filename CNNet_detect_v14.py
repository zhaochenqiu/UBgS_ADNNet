...
#         super().__init__()
#
#         self.conv1 = nn.Conv2d(1, 100, (201, 3) )
# #        self.conv2 = nn.Conv2d(10, 500, (1, 201))
#
#         self.fc1 = nn.Linear(100, 100)
#
#         self.fc_b1 = nn.Linear(100, 200)
#
#         self.fc_b2 = nn.Linear(200, 400)
#
#         self.fc_p1 = nn.Linear(400, 512)
#
...
#         super().__init__()
#
#         self.conv1 = nn.Conv2d(1, 50, (201, 3) )
# #        self.conv2 = nn.Conv2d(10, 500, (1, 201))
#
#         self.fc_b1 = nn.Linear(50, 200)
#
#
#         self.fc_p1 = nn.Linear(200, 512)
#
#         self.fc2 = nn.Linear(512, 2)
#
#     def forward(self, input):
...
class ClassifyNetwork(nn.Module):
    def __init__(self, dis_num):
        ...
        self.conv1 = nn.Conv2d(1, 256, (201, 3) )
#        self.conv2 = nn.Conv2d(10, 500, (1, 201))

        self.fc_b1 = nn.Linear(256, 512 )


        self.fc_p1 = nn.Linear(512, 1024)

        self.fc_p2 = nn.Linear(1024, 2048)
